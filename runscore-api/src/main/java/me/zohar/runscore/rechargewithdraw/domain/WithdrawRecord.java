...
public class WithdrawRecord implements Serializable {
	...
	public void setVirtualWalletInfo(VirtualWallet virtualWallet) {
		this.setWithdrawWay(Constant.提现方式_电子钱包);
		this.setVirtualWalletType(virtualWallet.getVirtualWalletType());
		this.setVirtualWalletAddr(virtualWallet.getVirtualWalletAddr());
	}
