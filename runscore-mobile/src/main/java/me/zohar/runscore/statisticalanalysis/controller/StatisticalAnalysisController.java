...
public class StatisticalAnalysisController {
	...
	@GetMapping("/findMyTotalReceiveResultsSituation")
	@ResponseBody
	public Result findMyTotalReceiveResultsSituation() {
		UserAccountDetails user = (UserAccountDetails) SecurityContextHolder.getContext().getAuthentication()
				.getPrincipal();
		return Result.success().setData(statisticalAnalysisService.findMyTotalReceiveResultsSituation(user.getUserAccountId()));
	}



	@GetMapping("/findMyReceiveResultsSituation")
	@ResponseBody
	public Result findMyReceiveResultsSituation(String id) {
		return Result.success().setData(statisticalAnalysisService.findMyTotalReceiveResultsSituation(id));
	}
}
